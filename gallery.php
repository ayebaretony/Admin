...
<html lang="en">
  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="<?php bloginfo('template_directory');?>/gallery.php">Gallery</a></li>
      ...
      *********************************************************************************************************************************************************** -->
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<?php bloginfo('template_directory');?>/assets/img/portfolio/port04.jpg"><img class="img-responsive" src="<?php bloginfo('template_directory');?>/assets/img/portfolio/port04.jpg" alt=""></a>
		                            </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<?php bloginfo('template_directory');?>/assets/img/portfolio/port05.jpg"><img class="img-responsive" src="<?php bloginfo('template_directory');?>/assets/img/portfolio/port05.jpg" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<?php bloginfo('template_directory');?>/assets/img/portfolio/port06.jpg"><img class="img-responsive" src="<?php bloginfo('template_directory');?>/assets/img/portfolio/port06.jpg" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<?php bloginfo('template_directory');?>/assets/img/portfolio/port01.jpg"><img class="img-responsive" src="<?php bloginfo('template_directory');?>/assets/img/portfolio/port01.jpg" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<?php bloginfo('template_directory');?>/assets/img/portfolio/port02.jpg"><img class="img-responsive" src="<?php bloginfo('template_directory');?>/assets/img/portfolio/port02.jpg" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<?php bloginfo('template_directory');?>/assets/img/portfolio/port03.jpg"><img class="img-responsive" src="<?php bloginfo('template_directory');?>/assets/img/portfolio/port03.jpg" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?php bloginfo('template_directory');?>/gallery.php#" class="go-top">
	...
	<script src="<?php bloginfo('template_directory');?>/assets/js/fancybox/jquery.fancybox.js"></script>    
