              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="<?php bloginfo('template_directory');?>/responsive_table.php">Responsive Table</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?php bloginfo('template_directory');?>/javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?php bloginfo('template_directory');?>/responsive_table.php#" class="go-top">
